...
public class PacketInitializeMBS extends PacketEC {
	...
	public PacketInitializeMBS(WorldChunk worldChunk) {
		this(worldChunk.getBaseCoordinate().x, worldChunk.getBaseCoordinate().y, worldChunk.getBaseCoordinate().z, worldChunk.getWidth(), worldChunk.getHeight(), worldChunk.getDepth());
	}
