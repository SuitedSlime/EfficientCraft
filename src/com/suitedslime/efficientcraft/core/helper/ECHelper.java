...
public abstract class ECHelper {
     ...
     * as long as their is a structure block within the immediate surroundings of the chunk.
     * 
    ...
    public static WorldChunk getChunkSurrounding(WorldCoordinate coords) {
        ...
        int[] newMeasures;
        int i = 0; // This is to prevent infinite loops. Max dimensions: 25*25*25
    ...
    private static int[] getNewMeasures(WorldCoordinate coords, int[] measures) {
        ...
        // Check Z-Axis (upper)
        if (containsStructureBlock(coords, -measures[lowerX], -measures[upperY], -measures[upperZ] + 1, width, height, 1))
            array[upperZ]++; 
